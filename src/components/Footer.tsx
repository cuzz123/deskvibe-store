  ...
  return (
    <footer className="bg-stone-50 border-t border-stone-200 mt-16">
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          <h4 className="text-xs uppercase tracking-[1.2px] text-stone-500 font-bold mb-3">Shop</h4>
        ...
        <div>
          <h4 className="text-xs uppercase tracking-[1.2px] text-stone-500 font-bold mb-3">Support</h4>
        ...
        <div>
          <h4 className="text-xs uppercase tracking-[1.2px] text-stone-500 font-bold mb-3">About</h4>
      ...
      <div className="max-w-7xl mx-auto px-6 py-5 border-t border-stone-200 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-stone-500">
